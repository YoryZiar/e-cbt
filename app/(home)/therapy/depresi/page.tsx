            ...
            <div className="container mx-auto px-4 relative z-10 max-w-4xl">
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[2.5rem] shadow-2xl p-8 lg:p-14">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl lg:text-5xl font-bold text-white mb-6">Depresi</h1>
                        <p className="text-slate-300 font-light leading-relaxed text-lg max-w-3xl mx-auto">Berikut cara mengatasi Depresi yang Bisa Diterapkan secara Mandiri :</p>
                    </div>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
                        <ul className="space-y-6">
                            ...
                            <li className="flex items-start">
                                    ...
                                    <div className="text-slate-300 font-light text-lg pt-1">
                                        Hindari media sosial atau hal-hal yang dapat menambah beban pikiran.
                                    </div>
                                </li>
                            <li className="flex items-start">
                                    <div className="min-w-10 h-10 rounded-full bg-secondary text-primary flex items-center justify-center font-bold mr-5 shrink-0">
