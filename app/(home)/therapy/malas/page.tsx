            ...
            <div className="container mx-auto px-4 relative z-10 max-w-4xl">
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[2.5rem] shadow-2xl p-8 lg:p-14">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl lg:text-5xl font-bold text-white mb-6">Malas</h1>
                        <p className="text-slate-300 font-light leading-relaxed text-lg max-w-3xl mx-auto">Beberapa cara untuk dapat mengatasi rasa malas dalam diri sendiri menurut psikologi adalah:</p>
                    </div>
                        ...
                        <ul className="space-y-6">
                            <li className="flex items-start">
                                    ...
                                    <div className="text-slate-300 font-light text-lg pt-1">
                                        Membuat tujuan yang realistis. Rasa malas kerap disebabkan oleh kurangnya motivasi untuk melakukan sesuatu. Oleh karena itu, seseorang bisa membuat tujuan atau target realistis
                                    </div>
                                </li>
                            <li className="flex items-start">
                                    <div className="min-w-10 h-10 rounded-full bg-secondary text-primary flex items-center justify-center font-bold mr-5 shrink-0">
                                    ...
                                    <div className="text-slate-300 font-light text-lg pt-1">
                                        Menghargai proses dan setiap usaha yang telah dilakukan.
                                    </div>
                                </li>
                            <li className="flex items-start">
                                    <div className="min-w-10 h-10 rounded-full bg-secondary text-primary flex items-center justify-center font-bold mr-5 shrink-0">
                            ...
                            <li className="flex items-start">
                                    ...
                                    <div className="text-slate-300 font-light text-lg pt-1">
                                        Hindari sifat terlalu perfeksionis.
                                    </div>
                                </li>
                            <li className="flex items-start">
                                    <div className="min-w-10 h-10 rounded-full bg-secondary text-primary flex items-center justify-center font-bold mr-5 shrink-0">
                                    ...
                                    <div className="text-slate-300 font-light text-lg pt-1">
                                        Terapkan afirmasi dan positive self-talk.
                                    </div>
                                </li>
                            <li className="flex items-start">
                                    <div className="min-w-10 h-10 rounded-full bg-secondary text-primary flex items-center justify-center font-bold mr-5 shrink-0">
                            ...
                            <li className="flex items-start">
                                    ...
                                    <div className="text-slate-300 font-light text-lg pt-1">
                                        Hindari distraksi atau mengalihkan perhatian dari hal yang sedang dilakukan.
                                    </div>
                                </li>
                        </ul>
                    </div>
