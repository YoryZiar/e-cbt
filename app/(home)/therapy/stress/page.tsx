            ...
            <div className="container mx-auto px-4 relative z-10 max-w-4xl">
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[2.5rem] shadow-2xl p-8 lg:p-14">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl lg:text-5xl font-bold text-white mb-6">Stres</h1>
                        <p className="text-slate-300 font-light leading-relaxed text-lg max-w-3xl mx-auto">Berikut beberapa cara yang dapat dilakukan untuk mengatasi stress:</p>
                    </div>
