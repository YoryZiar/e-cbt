...
import { CornerDownLeft, BookOpen, MessageCircle, Clock, User, ArrowLeft, BookMarked } from "lucide-react";
import {
    getJurnalById,
    getCommentByJurnal
            ...
            <div className="container max-w-4xl mx-auto px-4 relative z-10">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex items-center gap-1.5 bg-secondary/10 border border-secondary/20 rounded-full px-3 py-1">
                                        <BookMarked className="w-3 h-3 text-secondary/70" />
                                        <span className="text-xs text-secondary/70 font-medium">Jurnal Saya</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
                    <div className="px-8 py-5 border-b border-white/10">
                        ...
                        <p className="text-slate-400 text-sm mt-0.5">Tuliskan komentar atau tanggapan Anda</p>
                    </div>
